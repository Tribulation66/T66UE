...
- Run `C:\UE\T66\Scripts\CaptureT66GameplayVideo.ps1` with:
  - `-CaptureMode hero1axeaoewateridolimpact`
  - `-Hero1AxeProofIdol Idol_Water`
  - retained PNG frames
  - evidence bundle/contact sheet enabled
  - `T66.Combat.ImpactSourceVerbose 1`
  - Hero 1 AOE proof staging flags already used by the prior validated proof script.
- Output under `C:\UE\T66\Saved\VideoCaptures\Hero1AxeAOE_WaterIdolImpact_UserVideo_<timestamp>`.
