...
- Staged standalone:
  ...
  - `Reports/AgentReviews/20260531_HeadshotChanceStat/staged_stat_pipeline_smoke.json`: `ok=true`.
    - Packaged build proves Headshot item/stat, fixed `2x` crit, legacy backend mapping, legacy multiplier rejection, string-key serialization, retired UI text, boss stun, and `0.750s` target stun application.
