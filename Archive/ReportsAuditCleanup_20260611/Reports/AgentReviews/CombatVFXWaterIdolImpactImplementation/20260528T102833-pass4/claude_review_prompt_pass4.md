...
- Water idol is the first idol-context consumer:
  ...
  - Water applies damage under `SourceID=Idol_Water`.
...
- Left other idols on the legacy payload path for now, with an Earth neutral proof confirming no Water-only placeholder/impact path leakage.
...
- C++ editor build:
  ...
  - Result: success.
  - Known pre-existing warning on first full build: `T66Hero1AxeAOEVFXLabActor.cpp(353,3): warning C4996: FNiagaraEmitterInstance::IsReadyToRun`.
...
- Water/Earth proof wrapper:
  - Command: `& .\Scripts\RunHero1AxeAOEWaterIdolImpactProof.ps1 -OutputRoot 'C:\UE\T66\Saved\VideoCaptures\Hero1AxeAOE_WaterIdolImpactProof_20260528_102000'`
  - Result: exit 0.
  - Summary: `C:\UE\T66\Saved\VideoCaptures\Hero1AxeAOE_WaterIdolImpactProof_20260528_102000\Hero1AxeAOEWaterIdolImpactProofSummary.md`
  - Water video: `C:\UE\T66\Saved\VideoCaptures\Hero1AxeAOE_WaterIdolImpactProof_20260528_102000\WaterImpact\WaterImpact.mp4`
  - Water contact sheet: `C:\UE\T66\Saved\VideoCaptures\Hero1AxeAOE_WaterIdolImpactProof_20260528_102000\WaterImpact\evidence\contact_sheet.png`
  - Earth video: `C:\UE\T66\Saved\VideoCaptures\Hero1AxeAOE_WaterIdolImpactProof_20260528_102000\EarthNeutral\EarthNeutral.mp4`
  - Earth contact sheet: `C:\UE\T66\Saved\VideoCaptures\Hero1AxeAOE_WaterIdolImpactProof_20260528_102000\EarthNeutral\evidence\contact_sheet.png`
- Staged standalone:
...
- Staged launch smoke:
  - Command: `& .\Scripts\CaptureT66UIScreen.ps1 -Screen MainMenu -Output 'C:\UE\T66\Saved\VideoCaptures\Hero1AxeAOE_WaterIdolImpactProof_20260528_102000\StagedStandalone_MainMenu.png' -ResX 1280 -ResY 720 -DelaySeconds 2.5 -TimeoutSeconds 60`
  - Result: screenshot captured.
  - Staged screenshot: `C:\UE\T66\Saved\VideoCaptures\Hero1AxeAOE_WaterIdolImpactProof_20260528_102000\StagedStandalone_MainMenu.png`
...
- Water proof:
  ...
  - `CombatIdolWaterImpactResolved ... RadiusSource=FIdolData.AoeRadius AoeDelay=0.150 Applied=false Reason=LegacyImmediatePreserved`
  ...
  - `DamageBySource SourceID=Idol_Water TotalDamage=36`
- Earth neutral proof:
  - `CombatImpactContext Phase=WeaponPrimary SourceType=WeaponBase SourceID=Hero_1_black_aoe`
  - `Target=InnerHollow ExpectedHit=0 ActualHit=0 ... Result=PASS`
  - `DamageBySource SourceID=Idol_Earth TotalDamage=32`
  - Forbidden Water-only patterns were absent: `CombatIdolWaterImpactResolved`, `CombatVFXIdolImpactPlaceholderSpawned`.
...
- Idol-owned damage source: PRESENT for Water. Evidence: `SourceType=IdolModifier`, `SourceID=Idol_Water`, separate target query, separate `DamageBySource`.
- Idol-owned impact point: PRESENT for Water. Evidence: idol context impact point and blue sphere spawned at that point.
- Future Niagara binding seam: PRESENT. Evidence: idol binding lookup/spawn helper exists and currently falls through to placeholder because no Water idol Niagara is authored yet.
