...
- Report marker check: Reports/AGENTS.md already routes proof runs under `Reports/Proof/<Domain>/<TaskSlug>` and says new raw run folders should include `.report-run.json`; markers exist at the parent baseline proof folder and in the `EvidenceBundleSelfTest`, `BindingValidatorSelfTest`, and `AutoFrameSelection_Hero1AxeAOE_EdgeFinal` child evidence folders.
- PROOF_SUMMARY.md now states the child evidence folders carry their own `.report-run.json` markers pointing back to the durable proof summary.
...
A	Reports/AgentReviews/VFXDurableBaselineImplementation_20260528/StagedDiffReview/20260528T085101-pass5/claude_review_pass5.md
A	Reports/AgentReviews/VFXDurableBaselineImplementation_20260528/StagedDiffReview/20260528T085101-pass5/claude_review_prompt_pass5.md
...
A	Reports/Proof/CombatVFX/VFXDurableBaseline_20260528/AutoFrameSelection_Hero1AxeAOE_EdgeFinal/.report-run.json
...
A	Reports/Proof/CombatVFX/VFXDurableBaseline_20260528/BindingValidatorSelfTest/.report-run.json
...
A	Reports/Proof/CombatVFX/VFXDurableBaseline_20260528/EvidenceBundleSelfTest/.report-run.json
