...
- Multi-frame animation proof must be concrete: either an Unreal-owned screenshot sequence showing changed VAT poses over at least 3 frames per sampled family/clip, or a bounded sampled `Frame` scalar report at 3+ timestamps per sampled family/clip. A single still image is not enough.
