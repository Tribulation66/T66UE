...
- A same-working-tree VFX cleanup and handoff is prepared: it documents the live tree, hitbox contract, proof bundle, and untracked-file caveats. It is a pre-commit handoff, not a fresh-clone guarantee, until the untracked infrastructure/report files are committed or otherwise restored in the next session.
