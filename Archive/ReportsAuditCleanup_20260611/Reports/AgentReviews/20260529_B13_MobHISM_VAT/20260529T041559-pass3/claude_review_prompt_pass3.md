...
Review scope:
- Packet path: C:\UE\T66\Reports\AgentReviews\20260529_B13_MobHISM_VAT\combined_packet.md
...
All captures were full-resolution 1920x1080 with `r.ScreenPercentage=100`, `HeroHPOverride=20000`, stable binary hashes within each set, and no PerformanceSystem overhead rejects.
