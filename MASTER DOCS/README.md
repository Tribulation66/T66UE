...
- `MASTER_PLAYER_EXPERIENCE.md`: player-experience source of truth, including expected outcomes, stage pacing, tower structure, miasma pressure, interactable frequency, hero growth, and item/alchemy stat pressure.
- `MASTER_MOVEMENT.md`: player-hero movement source of truth, including input ownership, locomotion, jump, dash, velocity-affecting effects, and current movement drift notes.
- `MASTER_COMBAT.md`: combat runtime, targeting, damage routing, hit zones, and boss-part combat plan.
- `MASTER_CAMERA.md`: gameplay camera ownership, zoom and scoped overrides, occluder handling, frontend preview cameras, and T66Mini camera rules.
