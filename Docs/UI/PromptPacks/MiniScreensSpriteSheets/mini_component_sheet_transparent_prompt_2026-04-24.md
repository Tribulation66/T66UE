...
Primary request: Create a clean text-free fantasy UI component sprite sheet for a dark cathedral mini-game frontend, matching ornate dark stone, aged bronze-gold trim, small purple crystal accents, green enamel success buttons, blue back buttons, and purple magic action buttons. Components must be empty plates with no letters, no numbers, no icons, no avatars, no labels, no values, no UI text.
...
Style/medium: polished 2D fantasy game UI sprites, hand-painted but crisp, high contrast edges, same visual language as an ornate fantasy main menu.

Materials/textures: dark charcoal slate interiors, beveled bronze/gold metal borders, dark carved stone, small purple crystal gems, subtle inner vignette inside panels only.
