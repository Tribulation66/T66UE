...
Primary request: Create a clean text-free UI component sprite sheet for a dark Chadpocalypse mini-game frontend. This pass focuses on readable title plaques, footer bars, buttons, metric chips, and summary rows that match the approved clean main-menu color scheme without adding noisy ornament.
...
Style/medium: polished 2D game UI sprites, sleek modern minimalist surfaces, crisp high contrast edges, readable silhouettes, same red/black/charcoal/gold visual language as the approved main menu.

Materials/textures: dark charcoal planar interiors, satin bronze-gold metal borders, clean flat/satin enamel on colored button plates, restrained inner vignette inside plates only. Avoid grain, cracked stone, gemstone/crystal surfaces, noisy distressed panels, rubble texture, carved stone, chipped edges, micro-detail borders, and fantasy jewel ornaments.
