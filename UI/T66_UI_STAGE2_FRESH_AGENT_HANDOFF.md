...
1. `C:\UE\T66\UI\T66_UI_FIDELITY_LOOP.md` — canonical procedure and acceptance gate.
2. `C:\UE\T66\UI\T66_UI_FLAT_REDESIGN_PLAN.md` — master plan, palette, helper expectations, and per-screen specs.
...
6. `C:\UE\T66\UI\stage2_capture_readiness.md` — canonical capture names and parent-tab routing.
...
For each screen, follow `T66_UI_FIDELITY_LOOP.md` exactly:
...
- All eleven remaining Stage 2 screen names are accepted by the resolver. See `C:\UE\T66\UI\stage2_capture_readiness.md`.
