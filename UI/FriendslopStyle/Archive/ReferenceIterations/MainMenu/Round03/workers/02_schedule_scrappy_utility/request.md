...
Image prompt:
# Round03 Prompt 02: Schedule I-Style Scrappy Utility
...
Style direction: Schedule I-inspired UI visual language, but do not copy drug/crime theme. Use scrappy small-business utility UI: off-white receipt-paper panels, dark green headers, black rubber-stamp outlines, cheap storefront label strips, cash-register button shapes, tabbed paper folders, subtle paper grain, tape corners, sticker labels, slightly grimy utilitarian surfaces, readable condensed typography. It should feel like a goofy co-op management menu made from receipts, labels, and shop signage.

Distinct title treatment for this image:
- `Chadpocalypse` is straight, not curved or arced.
- Use dark green condensed storefront-sign lettering on an off-white taped paper strip.
- Add tiny stamp/ink misregistration and black outline, but keep it readable.

Visual constraints:
- Keep the current dense three-region main-menu composition recognizable.
- UI text should appear as live text placed on top of panels, not painted permanently into the panel art.
- Use muted cream, dark green, black ink, faded red stamp accents, and dull yellow paper highlights.
...
C:\UE\T66\UI\FriendslopStyle\Reference\MainMenu\Round03\main_menu_reference_02_schedule_scrappy_utility_cli.png
