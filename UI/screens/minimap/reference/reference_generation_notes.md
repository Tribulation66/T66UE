...
Source current screenshot path: `C:\UE\T66\UI\screens\minimap\current\current_state_1920x1080.png`
...
Back button removed: no. This is an in-run overlay target.

Runtime-owned regions to preserve later:
- Minimap contents, map icons, player marker, route/fog data, and any live stage context.
