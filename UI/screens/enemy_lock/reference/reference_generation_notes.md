...
Source current screenshot path: `C:\UE\T66\UI\screens\enemy_lock\current\current_state_1920x1080.png`
...
- Enemy lock target marker, selection state, enemy position, and gameplay scene context.
