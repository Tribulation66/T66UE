...
Source current screenshot path: `C:\UE\T66\UI\screens\enemy_health_bar\current\current_state_1920x1080.png`
...
Current screenshot status: missing.

Back button removed: no. This is an in-run combat overlay target.

Runtime-owned regions to preserve later:
- Enemy identity/state, health fill/value, status effects, damage state, and gameplay scene context.

Status: blocked.

Blocker:
- Missing canonical current screenshot. No reference was generated or promoted.
