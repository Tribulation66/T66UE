...
- Raw generated source: `C:\UE\T66\UI\screens\account_status\reference\account_status_raw_imagegen_1672x941_v2.png`
- Canonical reference: `C:\UE\T66\UI\screens\account_status\reference\account_status_reference_1920x1080.png`
- Runtime-owned regions to preserve later: headings, labels, account standing text, appeal state, progress values/fills, dropdown values, table headings, difficulty rows, ranks, scores, times, empty-state text, top navigation labels, icon meanings, currency amount, and power button state.
- Reference status: accepted
- Notes for integrator: generated with native Codex imagegen, normalized deterministically from 1672x941 to 1920x1080.
