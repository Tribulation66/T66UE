...
- Raw generated source: `C:\UE\T66\UI\screens\powerup\reference\powerup_raw_imagegen_1672x941_v2.png`
- Canonical reference: `C:\UE\T66\UI\screens\powerup\reference\powerup_reference_1920x1080.png`
- Runtime-owned regions to preserve later: item category/name labels, stat names, progress values/fills, prices, currency values, tab labels/states, top navigation labels, and scrollbar state.
