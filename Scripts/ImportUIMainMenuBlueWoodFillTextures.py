...
SOURCE_RELATIVE = ("SourceAssets", "UI", "MainMenuBlueWoodFill")
TEXTURE_NAMES = [
    "T_UI_MainMenuBlueWoodFill_N",
    "T_UI_MainMenuBlueWoodFill_H",
    "T_UI_MainMenuBlueWoodFill_P",
]
...
def main():
    ...
    log("Main menu blue wood fill textures ready")
