...
out_dir = r'C:\UE\T66\SourceAssets\Import\VFX\Idol_Fire_Explosion\vdb_weight_bg_probe2'
...
for sock_name, value in [('Weight',1.0), ('Blackbody Intensity',2.5), ('Emission Strength',0.5)]:
    sock = pv.inputs.get(sock_name)
    print('SOCK', sock_name, sock)
    if sock is not None:
