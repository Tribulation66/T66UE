...
SOURCE_RELATIVE = ("SourceAssets", "UI", "RetroWoodTrimV2")
TEXTURE_NAMES = [
    "T_UI_RetroWoodTrimH_V2_N",
    "T_UI_RetroWoodTrimH_V2_H",
    "T_UI_RetroWoodTrimH_V2_P",
    "T_UI_RetroWoodTrimV_V2_N",
    "T_UI_RetroWoodTrimV_V2_H",
    "T_UI_RetroWoodTrimV_V2_P",
]
...
def main():
    ...
    log("Retro wood trim textures ready")
