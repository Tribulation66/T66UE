...
out_dir = r'C:\UE\T66\SourceAssets\Import\VFX\Idol_Fire_Explosion\vdb_gui_probe'
...
light_obj.rotation_euler = (0.95,0,0)
...
scene.frame_set(6)
scene.render.filepath = os.path.join(out_dir, 'gui_probe_render.png')
print('RENDER_START')
