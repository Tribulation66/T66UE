"""
Reload the Gambler visual data row and create the camera wall fade material.

Run with:
  UnrealEditor.exe T66.uproject -ExecutePythonScript="C:/UE/T66/Scripts/SetupGamblerVisualRowAndCameraWallOcclusionAndExit.py"
"""
...
LOG = "[SetupGamblerVisualRowAndCameraWallOcclusion]"
