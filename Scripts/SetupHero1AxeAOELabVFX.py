...
SLASH_LAYER_CONFIGS = [
    {
        ...
        "base_color": unreal.LinearColor(0.02, 0.30, 1.0, 1.0),
        "core_color": unreal.LinearColor(0.05, 0.54, 1.0, 1.0),
        "tip_color": unreal.LinearColor(0.82, 0.94, 1.0, 1.0),
        "impact_color": unreal.LinearColor(1.0, 1.0, 1.0, 1.0),
        "dissolve_pan": 0.92,
        "streak_strength": 0.45,
        "dissolve_strength": 0.08,
        "detail_floor": 0.78,
        "reveal_lead": 2.80,
        ...
        "glow_strength": 9.0,
        "opacity_boost": 0.68,
        "radial_bias_mode": "inner",
        "radial_bias_min": 0.18,
        "radial_bias_power": 1.25,
    },
    {
        "name": "Body",
        "asset_path": f"{SHARED_DIR}/M_Hero1AxeAOE_Slash_Body",
        "blend": unreal.BlendMode.BLEND_ADDITIVE,
        "base_color": unreal.LinearColor(1.0, 0.02, 0.035, 1.0),
        "core_color": unreal.LinearColor(1.0, 0.18, 0.16, 1.0),
        "tip_color": unreal.LinearColor(1.0, 0.88, 0.88, 1.0),
        "impact_color": unreal.LinearColor(1.0, 1.0, 1.0, 1.0),
        "dissolve_pan": 0.66,
        "streak_strength": 0.42,
        "dissolve_strength": 0.10,
        "detail_floor": 0.80,
        "reveal_lead": 2.60,
        ...
        "glow_strength": 8.0,
        "opacity_boost": 0.70,
        "radial_bias_mode": "outer",
        "radial_bias_min": 0.20,
        "radial_bias_power": 1.10,
    },
    {
        "name": "Dark",
        "asset_path": f"{SHARED_DIR}/M_Hero1AxeAOE_Slash_Dark",
        "blend": unreal.BlendMode.BLEND_TRANSLUCENT,
        "base_color": unreal.LinearColor(0.002, 0.010, 0.045, 1.0),
        "core_color": unreal.LinearColor(0.015, 0.045, 0.16, 1.0),
        "tip_color": unreal.LinearColor(0.10, 0.0, 0.018, 1.0),
        "impact_color": unreal.LinearColor(0.20, 0.26, 0.36, 1.0),
        "dissolve_pan": 0.33,
        "streak_strength": 0.18,
        "dissolve_strength": 0.08,
        "detail_floor": 0.64,
        "reveal_lead": 2.35,
