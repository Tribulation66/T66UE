...
SOURCE_RELATIVE = ("SourceAssets", "UI", "MainMenuArcaneFill")
TEXTURE_NAMES = [
    "T_UI_MainMenuArcaneFill_N",
    "T_UI_MainMenuArcaneFill_H",
    "T_UI_MainMenuArcaneFill_P",
]
...
def main():
    ...
    log("Main menu arcane fill textures ready")
