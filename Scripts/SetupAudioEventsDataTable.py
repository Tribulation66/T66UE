...
def build_event_specs():
    ...
    specs = [
        ...
        event("Hero.Attack.Hero_2", "Merlin unique primary attack.", ["water bolt"], VolumeMultiplier=0.88, PitchRandomRange=0.04),
        event("Hero.Attack.Hero_3", "Lu Bu unique primary attack.", ["mana bomb"], VolumeMultiplier=0.94, PitchRandomRange=0.04),
        event("Hero.Attack.Hero_4", "Mike unique primary attack.", ["flare nova"], VolumeMultiplier=0.93, PitchRandomRange=0.04),
        event("Hero.Attack.Hero_5", "George unique primary attack.", ["pew laser"], VolumeMultiplier=0.86, PitchRandomRange=0.035),
        event("Hero.Attack.Hero_6", "Zeus unique primary attack.", ["ricochet 1"], VolumeMultiplier=0.88, PitchRandomRange=0.04),
        event("Hero.Attack.Hero_7", "Robo unique primary attack.", ["ricochet 2"], VolumeMultiplier=0.88, PitchRandomRange=0.04),
        event("Hero.Attack.Hero_8", "Billy unique primary attack.", ["laser shot"], VolumeMultiplier=0.82, PitchRandomRange=0.035),
        event("Hero.Attack.Hero_9", "Rabbit unique primary attack.", ["bamboo whip"], VolumeMultiplier=0.86, PitchRandomRange=0.04),
        event("Hero.Attack.Hero_10", "Dog unique primary attack.", ["pyro burst"], VolumeMultiplier=0.94, PitchRandomRange=0.04),
        event("Hero.Attack.Hero_11", "Shroud unique primary attack.", ["sharp summon"], VolumeMultiplier=0.84, PitchRandomRange=0.035),
        event("Hero.Attack.Hero_12", "xQc unique primary attack.", ["comical shot"], VolumeMultiplier=0.84, PitchRandomRange=0.04),
        event("Hero.Attack.Hero_13", "Moist unique primary attack.", ["enemy debuff"], VolumeMultiplier=0.82, PitchRandomRange=0.04),
        event("Hero.Attack.Hero_14", "North unique primary attack.", ["weirdness"], VolumeMultiplier=0.82, PitchRandomRange=0.04),
        event("Hero.Attack.Hero_15", "Asmon unique primary attack.", ["critical strike"], VolumeMultiplier=0.9, PitchRandomRange=0.04),
        event("Hero.Attack.Hero_16", "Forsen unique primary attack.", ["hollow tornado"], VolumeMultiplier=0.86, PitchRandomRange=0.04),
