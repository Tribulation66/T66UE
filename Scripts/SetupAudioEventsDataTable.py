...
def build_event_specs():
    ...
    specs = [
        ...
        event("Hero.Attack.Hero_1", "George unique primary attack.", ["pew laser"], VolumeMultiplier=0.86, PitchRandomRange=0.035),
        ...
        event("Hero.Attack.Hero_4", "Billy unique primary attack.", ["laser shot"], VolumeMultiplier=0.82, PitchRandomRange=0.035),
        event("Hero.Attack.Hero_5", "Yakub unique primary attack.", ["sword slash"], VolumeMultiplier=0.9, PitchRandomRange=0.035),
        event("Hero.Attack.Hero_6", "Robo unique primary attack.", ["ricochet 2"], VolumeMultiplier=0.88, PitchRandomRange=0.04),
