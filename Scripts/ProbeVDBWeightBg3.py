...
out_dir = r'C:\UE\T66\SourceAssets\Import\VFX\Idol_Fire_Explosion\vdb_weight_bg_probe3'
...
print('SOCKETS', [s.name for s in pv.inputs])
pv.inputs[-1].default_value = 1.0
