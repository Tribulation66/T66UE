...
SOURCE_RELATIVE = ("SourceAssets", "UI", "MainMenuBlueTrim")
TEXTURE_NAMES = [
    "T_UI_MainMenuBlueTrimH_N",
    "T_UI_MainMenuBlueTrimH_H",
    "T_UI_MainMenuBlueTrimH_P",
    "T_UI_MainMenuBlueTrimV_N",
    "T_UI_MainMenuBlueTrimV_H",
    "T_UI_MainMenuBlueTrimV_P",
]
...
def main():
    ...
    log("Main menu blue trim textures ready")
