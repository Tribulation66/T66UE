"""
Import tower forest textures and create runtime material instances for the Tower preset Stage 2 theme.

Run in Unreal Editor:
  Tools -> Execute Python Script -> Scripts/SetupTowerForestMaterials.py
"""
...
LOG = "[TowerForestSetup]"
MASTER_PATH = "/Game/Materials/M_Environment_Unlit"
DEST_DIR = "/Game/World/Terrain/TowerForest"

IMPORTS = [
    {
        "source": ("output", "imagegen", "tower_forest_textures", "tower_forest_ground.png"),
        "texture_name": "T_TowerForestGround",
        "material_name": "MI_TowerForestGround",
    },
    {
        "source": ("output", "imagegen", "tower_forest_textures", "tower_forest_roof.png"),
        "texture_name": "T_TowerForestRoof",
        "material_name": "MI_TowerForestRoof",
    },
]
