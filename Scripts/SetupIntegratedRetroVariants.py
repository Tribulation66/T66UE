...
LOG = '[IntegratedRetroVariants]'
DEST_DIR = '/Game/Materials/Retro'
...
def build_character_material(collection):
    material, asset_path = recreate_material('M_Character_Unlit_RetroGeometry', used_with_skeletal_mesh=True)
...
def build_environment_material(collection):
    material, asset_path = recreate_material('M_Environment_Unlit_RetroGeometry', used_with_instanced_static_meshes=True)
...
def build_fbx_material(collection):
    material, asset_path = recreate_material('M_FBX_Unlit_RetroGeometry', used_with_skeletal_mesh=True)
...
def build_glb_material(collection):
    material, asset_path = recreate_material('M_GLB_Unlit_RetroGeometry', used_with_instanced_static_meshes=True, used_with_nanite=True)
...
def main():
    ...
    log('Integrated retro variant rebuild complete')
