...
Use `../Instructions/07_PIXAL3D_RUNPOD_SETUP_INSTRUCTIONS.md` for the step-by-step pod setup,
HF auth path, startup command, default generation settings, and smoke-test
verification. Use `../Instructions/08_PIXAL3D_TROUBLESHOOTING_INSTRUCTIONS.md` before
