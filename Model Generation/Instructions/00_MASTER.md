...
2. For TRELLIS RunPod setup, use `01_TRELLIS_RUNPOD_SETUP.md`.
...
7. For the separate Pixal3D RunPod path, read `../Pixal3D/README.md`, then `07_PIXAL3D_RUNPOD_SETUP.md`. Use `08_PIXAL3D_TROUBLESHOOTING.md` for CuMesh/export/remesh failures. Treat Pixal3D as research-only until licensing changes or legal approval is explicit.
