...
Automated hero and humanoid companion rigging is out of scope for this folder. The user is handling those manually. Do not revive the retired humanoid bakeoff process unless the user explicitly asks to restart that research.
