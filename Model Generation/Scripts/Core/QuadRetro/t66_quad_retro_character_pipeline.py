...
blender --background --python "Model Generation/Scripts/Core/QuadRetro/t66_quad_retro_character_pipeline.py" -- ^
  --input "C:/path/to/source.glb" ^
  --output-dir "C:/path/to/quad_retro_output" ^
  --target-quads 5000 ^
  --adaptive-size 50 ^
  --texture-size 256 ^
  --palette-size 24 ^
