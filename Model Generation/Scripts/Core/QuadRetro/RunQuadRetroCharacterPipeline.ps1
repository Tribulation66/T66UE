param(
    ...
    [double]$TargetLuminance = 0.50,
    [double]$MaxScalingFactor = 4.0,
...
$PipelineArgs += @(
    ...
    "--normalize-luminance", $NormalizeLuminance.ToString().ToLowerInvariant(),
    "--target-luminance", $TargetLuminance,
    "--max-scaling-factor", $MaxScalingFactor,
    "--saturation-boost", $SaturationBoost,
