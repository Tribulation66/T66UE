param(
    [string]$InputModel = "C:\UE\T66\Model Generation\Runs\Arthur\Raw\Arthur_HeroReference_Full_White_S1337_D80000_Trellis2.glb",
    [string]$OutputDir = "C:\UE\T66\Model Generation\Runs\Heroes\QuadRetroPipelineSmoke01",
    [string]$Label = "ArthurFullBody",
...
$ScriptPath = "C:\UE\T66\Model Generation\Scripts\t66_quad_retro_character_pipeline.py"
