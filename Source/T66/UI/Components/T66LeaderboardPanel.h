...
private:
	...
	T66RuntimeUIBrushAccess::FOptionalTextureBrush ReferenceFilterGlobalIconBrush;
	T66RuntimeUIBrushAccess::FOptionalTextureBrush ReferenceFilterFriendsIconBrush;
