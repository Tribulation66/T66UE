...
namespace T66CombatShared
{
	...
	// official weapon impact point). Idol_Earth is deliberately excluded: it is the neutral
	...
	// This is the impact-presentation set plus Idol_Earth (neutral control input).
