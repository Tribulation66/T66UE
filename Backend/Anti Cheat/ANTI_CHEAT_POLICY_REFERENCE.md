...
**Maintenance rule:** Update this file after every anti-cheat, run-summary telemetry, restriction, appeal, integrity, run-modifier, or leaderboard-eligibility change. If the change affects live backend behavior, update `Backend/BACKEND_SYSTEM_REFERENCE.md` in the same pass.
