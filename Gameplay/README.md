...
Gameplay-owned documentation now lives here instead of `MASTER DOCS` or `Docs`.
...
- [Traps](Traps): trap subsystem ownership, runtime rules, visuals, telegraphs, and trap-family implementation details.
- [World](World): tower map design, lighting, modular dungeon kit generation, and world-generation research boundaries.
