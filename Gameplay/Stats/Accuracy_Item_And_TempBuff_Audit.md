...
The old `Docs/UI/Item_Icon_Prompt_Pack.md` and `Docs/UI/Item_Icon_Prompt_Index.csv` prompt artifacts were stale relative to the current runtime and were removed with the old `Docs` cleanup.
