...
Use the existing TRELLIS.2 RunPod baseline in [MASTER_WORKFLOW.md](C:/UE/T66/Model%20Generation/Instructions/MASTER_WORKFLOW.md), plus the shared world/model rules in [SHARED_ASSET_PIPELINE.md](C:/UE/T66/Model%20Generation/Instructions/SHARED_ASSET_PIPELINE.md).
