...
**Companion docs:** `Release/PROJECT_GUIDELINES_INSTRUCTIONS.md`, `Gameplay/World/T66_MAP_DESIGN_REFERENCE.md`, `Model Generation/Instructions/05_UNREAL_IMPORT_AND_VALIDATION_INSTRUCTIONS.md`  
**Historical predecessor:** deleted during the Alpha 0.1 documentation cleanup; recover from git history if needed.  
...
Older lighting-history docs described eclipse/dungeon-era behavior. They were cleanup-deleted as historical reference; recover them from git history if that context is needed.
