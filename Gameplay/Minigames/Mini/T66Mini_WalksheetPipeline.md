...
For full 8-direction idle, walk, and attack atlases, use the shared [T66Minigame_CharacterAnimationProcess.md](C:/UE/T66/Gameplay/Minigames/T66Minigame_CharacterAnimationProcess.md). This file remains the lightweight Mini-specific 2x2 walk-candidate process.
