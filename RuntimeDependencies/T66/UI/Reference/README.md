...
```text
RuntimeDependencies/T66/UI/Reference/Screens/<ScreenName>/
RuntimeDependencies/T66/UI/Reference/Modals/<ModalName>/
RuntimeDependencies/T66/UI/Reference/Shared/
```
