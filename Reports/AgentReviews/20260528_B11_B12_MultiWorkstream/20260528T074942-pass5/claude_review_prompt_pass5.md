...
11. Confirm the eight current manager tick branches still advance VAT at most once per active mob per tick.
12. Preserve `AT66MobBase` actor tick disabled and do not introduce any component tick.
