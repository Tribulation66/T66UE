...
- Codex draft path: C:\UE\T66\Audit\Pending\T66_CONTENT_AUDIT_2026-06-02.md
- Independent answer path: C:\UE\T66\Reports\AgentReviews\ContentAuditFull\20260602T043406-IndependentAnswer-pass1\claude_review_pass1.md
...
| Arcade / Versus | 14 JSON interactable entries plus registry prototypes | `DEPRECATED` / `DEPRECATED_DISABLED` | `DEPRECATED_DISABLED` | [DefaultGame.ini](C:/UE/T66/Config/DefaultGame.ini:64), [DEPRECATED_CONTENT.md](C:/UE/T66/Demo/DEPRECATED_CONTENT.md:33) |
...
- Suspected issues: several hero rows use portrait paths whose folder numbers differ from row IDs, for example `Hero_1` uses `Hero_4` portrait paths in [Heroes.csv](C:/UE/T66/Content/Data/Heroes.csv:2). This may be intentional remapping, but it is a content visibility risk for Inventory to verify. See `CONTENTFIND-014`.
...
- Lifecycle status: `DEPRECATED`, `DEPRECATED_DISABLED`, `COMPAT_LEGACY`.
- Evidence tier: READ + STATIC_TRACE.
...
- Connections: release variant, top bar, UI manager, widget-game registry, each minigame module.
...
- Suspected issues: current code/data outgrew the master doc, which still says no screen registration/gameplay combat/data ingestion. Content scale is prototype-small: one stage and one tuning row with `DifficultyID=Prototype`. See `CONTENTFIND-012`.
- Evidence: [T66WidgetGameRegistry.cpp](C:/UE/T66/Source/T66/UI/WidgetGames/T66WidgetGameRegistry.cpp:334), [T66DeckDataSubsystem.cpp](C:/UE/T66/Source/T66Deck/Private/Core/T66DeckDataSubsystem.cpp:44), [T66DeckMainMenuScreen.cpp](C:/UE/T66/Source/T66Deck/Private/UI/Screens/T66DeckMainMenuScreen.cpp:324), [T66DeckMainMenuScreen.cpp](C:/UE/T66/Source/T66Deck/Private/UI/Screens/T66DeckMainMenuScreen.cpp:589), [T66Deck_MasterImplementation.md](C:/UE/T66/Gameplay/Minigames/Deck/T66Deck_MasterImplementation.md:7), [T66Deck_Tuning.csv](C:/UE/T66/Content/Deck/Data/T66Deck_Tuning.csv:2).
...
- Status tags: `PARTIAL`.
- Evidence tier: READ + STATIC_TRACE.
- What was found: `T66Idle_MasterImplementation.md` says infrastructure-only/no production data/finished gameplay loops, but current code loads authored CSVs and has gameplay UI. Also `T66Idle_Heroes.csv` names `Hero_12` as `Goblino Chad`, while main `Hero_12` is `Roach Chad` and main `Hero_9` is `Goblino Chad`.
...
- Status tags: `PARTIAL`, `FALLBACK_ROUTE`.
- Evidence tier: STATIC_TRACE.
...
- Status tags: `PARTIAL`, `ORPHAN_SUSPECT`.
- Evidence tier: READ.
- What was found: main `Hero_1` row references `Hero_4` portrait paths; later companion rows reuse earlier companion portrait paths. This may be intentional placeholder reuse, a model/portrait remap, or stale content.
- Why it matters: player-visible identity can diverge from ID/name data even when the row itself is active.
- Evidence: [Heroes.csv](C:/UE/T66/Content/Data/Heroes.csv:2), [Companions.csv](C:/UE/T66/Content/Data/Companions.csv:10), [Companions.csv](C:/UE/T66/Content/Data/Companions.csv:17).
