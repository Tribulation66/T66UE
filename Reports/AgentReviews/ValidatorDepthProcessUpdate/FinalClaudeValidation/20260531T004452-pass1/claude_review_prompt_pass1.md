...
- Known caveats: automatic enforcement for all broad packets was not implemented; the new behavior is protocol-directed and helper-supported via `-ReviewDepth deepened` or `-RiskReview`.
